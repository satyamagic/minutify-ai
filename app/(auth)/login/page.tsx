    ...
    <div className="bg-gray-900 border border-gray-800 rounded-lg p-8">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          disabled={loading}
          className="mt-4 w-full py-3 bg-white hover:bg-gray-100 disabled:bg-gray-700 disabled:cursor-not-allowed rounded-lg font-medium text-gray-900 transition-colors flex items-center justify-center gap-2"
        >
